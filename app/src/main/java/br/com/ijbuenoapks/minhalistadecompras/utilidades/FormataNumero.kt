package br.com.ijbuenoapks.minhalistadecompras.utilidades
...
class FormataNumero(digitsBeforeZero: Int?, digitsAfterZero: Int?) :
    InputFilter {
    ...
    init {
        mDigitsBeforeZero = digitsBeforeZero ?: DIGITS_BEFORE_ZERO_DEFAULT
        mDigitsAfterZero = digitsAfterZero ?: DIGITS_AFTER_ZERO_DEFAULT
